...
Later in this course we will also demonstrate how to update an image mode system to a new bootc container iamge from removable media, for scenarios that network access to an OCI container registry is not practical.
