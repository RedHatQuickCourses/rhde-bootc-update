...
IMPORTANT: Red Hat associates must enroll using its https://training-lms.redhat.com/sso/saml/auth/rhlpint?RelayState=deeplinkoffering%3D86334529[Red Hat Learning Portal^] entry, and Red Hat Partners must enroll using its https://training-lms.redhat.com/sso/saml/auth/rhopen?RelayState=deeplinkoffering%3D86336609[Red Hat Partner Connect^] entry.
